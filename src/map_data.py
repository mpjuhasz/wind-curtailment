...
def main():
    ...
    repd[["long", "lat"]] = repd.apply(lambda x: bng_xy_to_lat_long(x["x_coord"], x["y_coord"]), axis=1, result_type="expand")
    repd = repd[["site_name", "development_status", "long", "lat", "technology_type", "capacity", "county", "region", "country"]]
